...
import transformers
from transformers import AutoConfig, AutoModelForCausalLM, AutoTokenizer, EvalPrediction, TextDataset
...
class BertPretrainingCriterion(torch.nn.Module):
    ...
    def forward(self, prediction_scores, seq_relationship_score, masked_lm_labels, next_sentence_labels):
        ...
        return total_loss, masked_lm_loss, 0.0
...
def prepare_model_and_optimizer(args, device):
    ...
    config = AutoConfig.from_pretrained(args.config_file)
...
def main():
    ...
    folder_name = './results_gpt2_2enc_no_tying_fp16_correct_eval/checkpoints_gpt2xl_2enc_notying_pretraining/'
    ckpt_list = ['ckpt_995.pt', 'ckpt_1995.pt', 'ckpt_2994.pt', 'ckpt_3994.pt', 'ckpt_4993.pt', 'ckpt_5993.pt', 'ckpt_6992.pt', 'ckpt_7992.pt', 'ckpt_8991.pt', 'ckpt_9991.pt', 'ckpt_10990.pt']

    for ckpt in ckpt_list:

        checkpoint = torch.load(os.path.join(folder_name, ckpt), map_location="cpu")
        ...
        torch.save(save_state, folder_name + '/processed_' + ckpt)
    exit(0)
